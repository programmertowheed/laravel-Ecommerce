...
@section("content")
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header"><h4 class="text-center text-success">Add Product</h4></div>
                        ...
                        <form method="POST" action="{{ route('new-product') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8" style="margin-top: 18px;">
                                    <textarea name="long_description" id="editor" class="form-control" cols="30" rows="5">{{ old('long_description') }}</textarea>
