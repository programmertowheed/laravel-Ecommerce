<div class="main-header">
    ...
    <div class="logo-header" data-background-color="dark2">
        ...
        <a href="{{ route("admin.deshboard") }}" class="logo">
            <img src="{{ asset("/Backend") }}/logo.png" style="height: 75px;" alt="navbar brand" class="navbar-brand">
        </a>
            ...
            <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                ...
                <li class="nav-item dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                        <div class="avatar-sm">
                            <img src="{{ App\Helpers\ImageHelper::getAdminImage(Auth::user()->id) }}" alt="..." class="avatar-img rounded-circle">
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-user animated fadeIn">
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    <div class="avatar-lg"><img src="{{ App\Helpers\ImageHelper::getAdminImage(Auth::user()->id) }}" alt="image profile" class="avatar-img rounded"></div>
                                    <div class="u-text">
